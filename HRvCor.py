    ...
    while True:
        ...
        while bighousecount != big:
            ...
            # of where the house is to be placed, if so generate new x,y positionsk
                ...
                bighousecount += 1
                bighouses.append((x1,y1))
                bighouses.append((x2,y1))
                bighouses.append((x1,y2))
                bighouses.append((x2,y2))
                myset.add((x1,y1))
                myset.add((x2,y1))
                myset.add((x1,y2))
                myset.add((x2,y2))
        ...
        while midhousecount != middle:
            ...
            if (board[y1:y2,x1:x2] != 0).any():
                ...
                midhousecount += 1
                middlehouses.append((x1,y1))
                middlehouses.append((x2,y1))
                middlehouses.append((x1,y2))
                middlehouses.append((x2,y2))
                myset.add((x1,y1))
                myset.add((x2,y1))
                myset.add((x1,y2))
                myset.add((x2,y2))
        ...
        while smallhousecount != small:
            ...
            # of where the house is to be placed, if so generate new x,y positions
                ...
                smallhousecount += 1
                smallhouses.append((x1,y1))
                smallhouses.append((x2,y1))
                smallhouses.append((x1,y2))
                smallhouses.append((x2,y2))
                myset.add((x1,y1))
                myset.add((x2,y1))
                myset.add((x1,y2))
                myset.add((x2,y2))
