...
def generate_configuration():
    ...
    while time.time() < timeout:
        if time.time() + 1 >= timeout:
            print "i'm a bit stuck apperently"
...
def start_generator():
    print "terraforming grid"
    global board
    board = initboard()
    print "generating configuration"
    generate_configuration()
    print "cooking's done!"
