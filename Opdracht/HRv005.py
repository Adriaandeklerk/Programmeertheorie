...
def generate_configuration():
    ...
    #eerst kijken op rij 0, iedere kolumn kijken voor ruimte
    #    is er ruimte ga naar volgende rij
    #    doe hetzelfde
    #        volgende rij
    #            is genoeg ruimte voor huis
    #                verander de waarde can [[x,y]] naar 1 voor familyhome, 2 voor bungalow, 3 voor maison, 4 voor water
...
def main():
    ...
    print score(minimum, repititions)
